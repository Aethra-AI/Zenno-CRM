...
def deploy_tenant_agent_endpoint():
    ...
    try:
        ...
        master_llm_key = os.getenv('MOONSHOT_API_KEY') 
        pollination_key = os.getenv('POLLINATION_API_KEY')
...
@public_api_key_required
def get_public_vacancies_agent():
...
@public_api_key_required
def get_public_candidates_agent():
...
@public_api_key_required
def post_public_application_agent():
